...
export class Kunde {
        ...
        public email: string|undefined)
    {
        ...
        if (interessen === undefined) {
            ...
            const tmpSchlagwoerter = interessen as Array<string>
            this.interessen = tmpSchlagwoerter
        }
    ...
    updateStammdaten(
        ...
        umsatz: Umsatz|undefined, interessen: InteressenType|undefined ) {
        this.name = name
    ...
    hasSchlagwort(interessen: string) {
        ...
        const tmpSchlagwoerter = this.interessen as Array<string>
        return tmpSchlagwoerter.includes(interessen)
    }
